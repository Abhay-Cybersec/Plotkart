...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    // Google OAuth is configured in backend
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Sign in to your PlotKart account</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="space-y-2">
              <div>
                <p className="text-xs text-blue-700 font-semibold">Regular User (Seller):</p>
                <p className="text-xs text-blue-700">Email: john@example.com</p>
                <p className="text-xs text-blue-700">Password: password123</p>
              </div>
              <div className="pt-2 border-t border-blue-200">
                <p className="text-xs text-blue-700 font-semibold">Admin User:</p>
                <p className="text-xs text-blue-700">Email: admin@plotkart.com</p>
